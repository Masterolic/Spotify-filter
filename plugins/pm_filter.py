...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>🎬 Title:</b> {search}\n</b>\n<b><a href='https://t.me/Spotify_downloa_bot</a></b>\n\n<b>✍️ Note:</b> <s>contact @masterolic if you face any issues.</s>"
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            fek = await message.reply_photo(photo="https://telegra.ph//file/efd9fb628f01a2ba03e83.jpg", caption=cap, reply_to_message_id=reply_id, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(600)
            await fek.delete()
            await msg.delete()
    else:
        fuk = await message.reply_photo(photo="https://telegra.ph//file/efd9fb628f01a2ba03e83.jpg", caption=cap, reply_to_message_id=reply_id, reply_markup=InlineKeyboardMarkup(btn))
        await asyncio.sleep(600)
        await fuk.delete()
        await msg.delete()
    if spoll:
